        ...
        <div class="group">
            <div class="navItem">
                <span role="link" tabindex="0" onclick="openPage('search.php')" class="navItemLink">
                    Search <img src="assets/images/icons/search.png" class="icon" alt="Search button">
                </span>
            </div>
        </div>
        <div class="group">
            ...
            <div class="navItem">
                <span role="link" tabindex="0" onclick="openPage('test.php')" class="navItemLink">Test</span>
            </div>
        </div>
    </nav>
</div>